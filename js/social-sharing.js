...
if (in_wechat) {
    ...
    document.getElementById('wx-notice').innerHTML = "<br><strong class='important'>微信用户:</strong> 用浏览器打开, 可以将本游戏安装到手机桌面.<br><br>一手新鲜，关注<strong>SK8Tech</strong>:<br><img src='wx-qrcode.png' width='100%'/>";
    disable_fb();
